...
const BulkCancelModal: React.FC<BulkCancelModalProps> = ({
  ...
  const loadPreview = async () => {
    ...
    try {
      const res: any = await tasksAPI.previewBulkCancel({
        ...
        taskIds,
        supersedeActivities,
        activityDateFrom: supersedeActivities ? activityDateFrom : undefined,
        activityDateTo: supersedeActivities ? activityDateTo : undefined,
      });
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setError(e?.message || 'Failed to cancel tasks');
    } finally {
        ...
        <div className="rounded-2xl border border-slate-200 p-4 space-y-3">
          ...
          {supersedeActivities && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pl-7">
              ...
              {preview && activityDateFrom && activityDateTo && (
